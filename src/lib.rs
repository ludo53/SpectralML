...
#[derive(Debug)]
pub struct SpectralMLProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SpectralMLProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SpectralML processing");
    
    let mut processor = SpectralMLProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SpectralMLProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SpectralMLProcessor::new(false);
